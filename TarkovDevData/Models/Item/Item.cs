...
public class Item
{
    ...
    public long? ChangeLast48H {
        get;
        set;
    }

    [JsonPropertyName("changeLast48hPercent")]
    public double ChangeLast48HPercent {
        get;
        set;
    }

    [JsonPropertyName("low24hPrice")]
    public long? Low24hPrice {
        get;
        set;
    }

    [JsonPropertyName("lastLowPrice")]
    public long? LastLowPrice {
        get;
        set;
    }
    ...
    public List<ItemForWrapper> SellFor {
        get;
        set;
    }

    [JsonPropertyName("buyFor")]
    public List<ItemForWrapper> BuyFor {
        get;
        set;
    }
}